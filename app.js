...
changeLevel()
  ...
  // randomly select a Tetromino and its frist rotation
  ...
  // make the tetromino move down everyseconds
  ...
  // move the tetromino left, unless it meets the adge or blockage
  function moveLeft () {
    undraw()
  ...
  function addScore () {
    for (let i = 0; i < 199; i += width) {
      ...
      if (row.every(index => squares[index].classList.contains('taken'))) {
        ...
        squares = sqaresRemoved.concar(squares)
